...
export default function QCM() {
  ...
  const currentAttachmentUrl = (language === 'en' && currentQuestion?.attachmentUrl_en) ? currentQuestion.attachmentUrl_en : currentQuestion?.attachmentUrl;
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      >
        ...
        {(currentAttachmentUrl && (currentQuestion.attachmentType === 'image' || currentAttachmentUrl.match(/\.(jpeg|jpg|gif|png|webp|svg|avif)$/i) || currentAttachmentUrl.includes('drive.google.com') || currentAttachmentUrl.includes('docs.google.com') || currentAttachmentUrl.includes('hostinger'))) && (
          <div className="mb-8 group relative">
            <div className="rounded-2xl overflow-hidden border border-zinc-200 bg-white min-h-[100px] flex items-center justify-center shadow-sm">
              <img 
                key={currentAttachmentUrl}
                src={getDirectImageUrl(currentAttachmentUrl)} 
                onError={(e) => {
                  const target = e.target as HTMLImageElement;
                  const url = currentAttachmentUrl || '';
            ...
            <a 
              href={getDirectImageUrl(currentAttachmentUrl)} 
              target="_blank" 
        ...
        {currentAttachmentUrl && currentQuestion.attachmentType === 'pdf' && (
          <div className="mb-8">
            <a 
