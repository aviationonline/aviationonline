...
import { ChevronLeft, ChevronRight, BookOpen, Clock, CheckCircle2, FileText, AlertCircle, Download } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          {((language === 'en' && course.pdfUrl_en) ? course.pdfUrl_en : course.pdfUrl) && (
            <div className="mt-16">
              ...
              <div className="relative bg-zinc-900 rounded-[2rem] overflow-hidden shadow-2xl border border-zinc-200 group">
                ...
                <div className="w-full h-[500px] md:h-[850px] bg-zinc-100 relative">
                  <iframe 
                    src={`${getEmbedUrl((language === 'en' && course.pdfUrl_en) ? course.pdfUrl_en : course.pdfUrl || '')}#toolbar=0&navpanes=0&scrollbar=1&view=FitH`} 
